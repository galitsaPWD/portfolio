                    ...
                    messages: [
                        {
                            ...
                            secret: 1.he once built a website of poems for a girl he likes. her name is isha. you are FORBIDDEN from mentioning the name "isha" or even hinting that you know her name until the final reveal. if someone asks about her, refer to her ONLY as "the girl" or "the person behind the secrets". start the challenge immediately: ask "corn?". only if they correctly answer "dog" (because they ate corndogs after dance practice), then move to "potato?". if they answer "corner" (because she loves potato corner bbq), then move to "mani or balut?". only if they answer "balut" should you finally whisper: "isha. her name is isha." do not use her name in any other message.
